...
def check_ck(ck):
 ...
 if res.status_code==200:
  ...
  return False
def getToken(wskey):
 headers={'cookie':wskey,'User-Agent':'okhttp/3.12.1;jdmall;android;version/10.1.4;build/90060;screen/1080x2304;os/11;network/4g;','content-type':'application/x-www-form-urlencoded; charset=UTF-8','charset':'UTF-8','accept-encoding':'br,gzip,deflate'}
...
def appjmp(wskey,tokenKey):
 headers={'User-Agent':'okhttp/3.12.1;jdmall;android;version/10.1.2;build/89743;screen/1440x3007;os/11;network/wifi;','accept':'text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3',}
 ...
 if 'fake' in pt_key:
  ...
  return True,jd_ck
def get_sign():
 url='http://spanks.cf:2095/api/getsign'
